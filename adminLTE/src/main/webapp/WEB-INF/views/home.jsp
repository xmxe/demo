...
<style type="text/css">
#content{width:100%;padding-left:230px;min-height:1000px;z-index: 333;}
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="content.html"  onclick="document.frames('ifrmname').location.reload()"  target="myFrame" class="logo">
