...
<head>
  ...
  <link rel="stylesheet" href="<%=basePath%>self/css/screen.css"  media="screen">
  <link rel="stylesheet" href="<%=basePath%>self/css/jquery.treetable.css">
  <link rel="stylesheet" href="<%=basePath%>self/css/jquery.treetable.theme.default.css">
...
<style type="text/css">
  .content-wrapper, .main-footer{margin-left:0px;position:fixed;bottom:0;right:0;width: 100%;}
...
<script src="<%=basePath%>self/js/jquery.treetable.js"></script>
