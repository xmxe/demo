		...
		$(function() {
			...
			$.ajax({
				...
				/* 	 var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
		            ...
		            for (var i = 0; i < nodes.length; i++) { //设置节点关闭
...
.ztree li span.button.pIcon01_ico_open {
	margin-right: 2px;
	background: url(<%=basePath%>zTree_v3/css/zTreeStyle/img/diy/bold_16x16.gif)
...
.ztree li span.button.pIcon01_ico_close {
	margin-right: 2px;
	background:
		url(zTree_v3/css/zTreeStyle/img/diy/backup_16x16.gif)
		no-repeat scroll 0 0 transparent;
	vertical-align: top;
	*vertical-align: middle
}
...
.ztree li span.button.icon03_ico_docu {
	margin-right: 2px;
	background: url(<%=basePath%>zTree_v3/css/zTreeStyle/img/diy/comment1_16x16.gif)
		no-repeat scroll 0 0 transparent;
	vertical-align: top;
	*vertical-align: middle
}
							...
							<h3 class="box-title">模板详情</h3>
							  ...
							  <div class="panel-body" style="padding-left: 10px;">
								  ...
								  <div class="btn-group" role="group">
								    <button id="add_same_level" type="button" onclick="add_same_levels();" class="btn btn-info active" disabled="disabled">
								    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
								    	添加同级
								    </button>
								  </div>
								  <div class="btn-group" role="group">
								    <button type="button" onclick="add_next_levels();" class="btn btn-info active" disabled="disabled">
								    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
								  	  添加下级
								    </button>
								  </div>
								  <div class="btn-group" role="group">
								    <button type="button" class="btn btn-info active" onclick="removeHoverDom('treeDemo', '1')">
								...
								<p style="margin-left:50px;">
									<button type="button" onclick="save_template()" class="btn btn-info  btn-lg">
