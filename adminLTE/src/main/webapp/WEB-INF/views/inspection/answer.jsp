...
.ztree li span.button.icon03_ico_docu {
	margin-right: 2px;
	background: url(<%=basePath%>zTree_v3/css/zTreeStyle/img/diy/user7_16x16.gif)
		no-repeat scroll 0 0 transparent;
	vertical-align: top;
	*vertical-align: middle
}
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
			...
			<shiro:hasRole name="a">
				<button type="button" class="btn btn-danger" data-dismiss="modal">hasRole</button>
			</shiro:hasRole>
			  <shiro:hasAnyRoles name="a,b">
				  <button type="button" class="btn btn-danger" data-dismiss="modal">hasAnyRole</button>
			  </shiro:hasAnyRoles>
