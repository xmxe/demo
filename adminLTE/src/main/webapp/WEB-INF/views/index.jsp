...
<head>
  ...
  <title>欢迎使用adminLTE</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="<%=basePath%>/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <%-- <link rel="icon" href="<%=basePath%>/imge/jf.ico" type="image/x-icon"/> --%>
  <!-- Font Awesome -->
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<%=basePath%>/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<%=basePath%>/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<%=basePath%>/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<%=basePath%>/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<%=basePath%>/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>济南房地产网</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="reIframeHeight('dept')"><i class="fa fa-circle-o"></i> 人员管理 </a></li>
            <li><a href="dept"><i class="fa fa-circle-o"></i> <%=basePath%>self/js/iframe.js</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <iframe id="content" scroll="no"  min-height="1000px" src="dept.action"></iframe>
