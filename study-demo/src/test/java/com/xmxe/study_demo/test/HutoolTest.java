...
public class HutoolTest {
    ...
    public void datetime() {
        ...
        /*
         * DateUtil.parse()会自动识别一些常用的格式，比如说：yyyy-MM-dd HH:mm:ss,yyyy-MM-dd,HH:mm:ss,yyyy-MM-dd HH:mm,yyyy-MM-dd HH:mm:ss.SSS
         * 还可以识别带中文的：年月日时分秒,格式化时间差：
         */
    ...
    public void string() {
        String template = "{},{}";
        String str = StrUtil.format(template, "hello", "world");
    }
    ...
    @Test
    public void console() {
        // 本地编码的过程中，经常需要使用System.out打印结果，但是往往一些复杂的对象不支持直接打印,比如说数组，需要调用Arrays.toString。
        // Hutool封装的Console类借鉴了JavaScript中的console.log()，使得打印变成了一个非常便捷的方式。
    ...
    public void cache() {
        ...
        fifoCache.put("key1", "v1");
        fifoCache.put("key2", "v2");
        fifoCache.put("key3", "v3");
        fifoCache.put("key4", "v4");
        ...
        lfuCache.put("key1", "v1");
        // 使用次数+1
        lfuCache.get("key1");
        lfuCache.put("key2", "v2");
        lfuCache.put("key3", "v3");
        lfuCache.put("key4", "v4");
    ...
    public void decrypt() {
         ...
         * 摘要加密Digester
         * 快速加密工具类SecureUtil有以下这些方法：
         * 1）对称加密:SecureUtil.aes、SecureUtil.des
         * 2）非对称加密:SecureUtil.rsa、SecureUtil.dsa
         * 3）摘要加密:SecureUtil.md5、SecureUtil.sha1、SecureUtil.hmac、SecureUtil.hmacMd5、SecureUtil.hmacSha1
         */

        AES aes = SecureUtil.aes();
        String encry = aes.encryptHex("hrrr");
...
/*
 * Hutool中的类库还有很多，尤其是一些对第三方类库的进一步封装，比如邮件工具MailUtil，二维码工具QrCodeUtil，Emoji工具EmojiUtil，
 * 小伙伴们可以参考Hutool的官方文档：https://www.hutool.cn/
 */
