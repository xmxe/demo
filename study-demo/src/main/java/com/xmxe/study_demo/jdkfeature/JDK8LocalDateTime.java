...
public class JDK8LocalDateTime {
    ...
    public void 获取年月日时分秒() {
        ...
        System.out.println("本年当中第:" + now.getDayOfYear() + "天");// 本年当中第:353天
    ...
    public void 时间戳转换() {
        ...
        System.out.println("LocalDateTime 毫秒数:" + localDateTime2Instant.toEpochMilli());// LocalDateTime
                                                                                        // 毫秒数:1539141733010

        // 时间戳转LocalDateTime
        DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        LocalDateTime local = LocalDateTime.ofInstant(Instant.ofEpochMilli(System.currentTimeMillis()),
    ...
    public void 时间相差比较() {
        ...
        // 2018-03-28T18:56:12.427与2018-01-13T22:30:10间隔
        // 天:-73
        // 时:-1772
        // 分:-106346
        // 毫秒:-6380762427
    ...
    public void 时区时间计算() {
        ...
        // 美国纽约此时的时间和时区: 2018-12-19T03:52:22.494-05:00[America/New_York]
    }
}