...
public class ThreadSequentialExecution {
     ...
     */
    static class SynchronizedWaitNotify {
        // 锁住的对象
     ...
     * 那么,在这道题里：线程A使用PipedOutStream向线程B写入数据,线程B读取后,打印输出.线程B和C也是相同的姿势
     */
    static class PipedStream_ {
